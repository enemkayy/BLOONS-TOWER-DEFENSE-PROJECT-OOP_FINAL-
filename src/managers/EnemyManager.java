...
public class EnemyManager {
	...
	public EnemyManager(Playing playing, PathPoint start, PathPoint end) {
		...
		/*
		 * addEnemy(Rbl); addEnemy(Bbl); addEnemy(Pbl); addEnemy(Sbl);
		 */
		loadEnemyImgs();
	}
	...
	private void loadEnemyImgs() {
		enemyImgs = new BufferedImage[4];
		enemyImgs[0] = LoadSave.getRedBloon();
		enemyImgs[1] = LoadSave.getBlueBloon();
		enemyImgs[2] = LoadSave.getPurpleBloon();
		enemyImgs[3] = LoadSave.getSpecialBloon();
	...
	public void addEnemy(int enemyType) {
		...
		switch (enemyType) {
		case Rbl:
			enemies.add(new Rbl(x, y, 0, this));
			break;
		case Bbl:
			enemies.add(new Bbl(x, y, 0, this));
			break;
		case Pbl:
			enemies.add(new Pbl(x, y, 0, this));
			break;
		case Sbl:
			enemies.add(new Sbl(x, y, 0, this));
			break;
		}
