...
//		sellTower, upgradeTower; 
	...
	private void drawButtons(Graphics g) {
		...
		for (MyButton b : towerButtons) {
			...
			g.drawImage(playing.getTowerManager().getMonkeyImgs()[b.getId()], b.x, b.y, b.width, b.height, null);
	...
	public void draw(Graphics g) {
		...
		if (playing.isGamePaused()) {
			...
			Font largeFont = new Font("LucidaSans", Font.BOLD, 50);
			g.setFont(largeFont);
			g.drawString("Game is Paused!", 120, 400);
		}

		// Lives
		// Reset font for "Lives" text
		Font defaultFont = new Font("LucidaSans", Font.BOLD, 20); // Adjust to your desired font and size
	...
	private void drawTowerCost(Graphics g) {
		...
		Font smallFont = new Font("LucidaSans", Font.BOLD, 16);
		g.setFont(smallFont);
		...
		if (isTowerCostMoreThanCurrentGold()) {
			...
			g.drawString("Can't Afford", 290, 715);
	...
	private void drawDisplayedTower(Graphics g) {
		if (displayedTower != null) {
			...
			g.drawImage(playing.getTowerManager().getMonkeyImgs()[displayedTower.getTowerType()], 420, 650, 50, 50,
					null);
			...
			g.drawString("Tier: " + displayedTower.getTier(), 580, 660);
